...
--
-- Name: gender; Type: TYPE; Schema: public; Owner: xsilhan2
--
...
ALTER TYPE public.gender OWNER TO xsilhan2;
...
--
-- Name: contact; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.contact OWNER TO xsilhan2;

--
-- Name: contact_id_contact_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.contact_id_contact_seq OWNER TO xsilhan2;

--
-- Name: contact_id_contact_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: contact_id_contact_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--

SELECT pg_catalog.setval('contact_id_contact_seq', 122, true);


--
-- Name: contact_type; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.contact_type OWNER TO xsilhan2;

--
-- Name: contact_type_id_contact_type_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.contact_type_id_contact_type_seq OWNER TO xsilhan2;

--
-- Name: contact_type_id_contact_type_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: contact_type_id_contact_type_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--
...
--
-- Name: location; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.location OWNER TO xsilhan2;

--
-- Name: location_id_location_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.location_id_location_seq OWNER TO xsilhan2;

--
-- Name: location_id_location_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: location_id_location_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--

SELECT pg_catalog.setval('location_id_location_seq', 52, true);


--
-- Name: meeting; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.meeting OWNER TO xsilhan2;

--
-- Name: meeting_id_meeting_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.meeting_id_meeting_seq OWNER TO xsilhan2;

--
-- Name: meeting_id_meeting_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: meeting_id_meeting_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--

SELECT pg_catalog.setval('meeting_id_meeting_seq', 30, true);


--
-- Name: person; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.person OWNER TO xsilhan2;

--
-- Name: person_id_person_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.person_id_person_seq OWNER TO xsilhan2;

--
-- Name: person_id_person_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: person_id_person_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--

SELECT pg_catalog.setval('person_id_person_seq', 74, true);


--
-- Name: person_meeting; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.person_meeting OWNER TO xsilhan2;

--
-- Name: relation; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.relation OWNER TO xsilhan2;

--
-- Name: relation_id_relation_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.relation_id_relation_seq OWNER TO xsilhan2;

--
-- Name: relation_id_relation_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: relation_id_relation_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--

SELECT pg_catalog.setval('relation_id_relation_seq', 102, true);


--
-- Name: relation_type; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.relation_type OWNER TO xsilhan2;

--
-- Name: relation_type_id_relation_type_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.relation_type_id_relation_type_seq OWNER TO xsilhan2;

--
-- Name: relation_type_id_relation_type_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: relation_type_id_relation_type_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
ALTER TABLE public.users OWNER TO xsilhan2;

--
-- Name: users_id_users_seq; Type: SEQUENCE; Schema: public; Owner: xsilhan2
--
...
ALTER TABLE public.users_id_users_seq OWNER TO xsilhan2;

--
-- Name: users_id_users_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xsilhan2
--
...
--
-- Name: users_id_users_seq; Type: SEQUENCE SET; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_contact; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_contact_type; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_location; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_meeting; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_person; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_relation; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_relation_type; Type: DEFAULT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: id_users; Type: DEFAULT; Schema: public; Owner: xsilhan2
--

ALTER TABLE ONLY users ALTER COLUMN id_users SET DEFAULT nextval('users_id_users_seq'::regclass);


--
-- Data for Name: contact; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
INSERT INTO contact VALUES (115, 3, 5, 'Test');
INSERT INTO contact VALUES (119, 39, 5, 'dsadasdadsad');
INSERT INTO contact VALUES (118, 39, 6, 'ahoj');
INSERT INTO contact VALUES (120, 38, 5, 'test');
INSERT INTO contact VALUES (113, 38, 6, 'test2');
INSERT INTO contact VALUES (121, 38, 5, 'cdasdas');


--
-- Data for Name: contact_type; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
--
-- Data for Name: location; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
INSERT INTO location VALUES (29, 'Jevicko', 'Komenskeho', 22, '58291', 'Ceska republika', 'Test', NULL, NULL);
INSERT INTO location VALUES (25, 'Hradec Králové', 'Govorova', 628, '500 06', 'Ceska Republika', NULL, NULL, NULL);
INSERT INTO location VALUES (23, 'Hradec Králové', 'Nový Hradec', 754, '500 06', 'Test', NULL, NULL, NULL);
INSERT INTO location VALUES (49, 'Hradec Králové', 'Velké náměstí', 26, '500 03', 'Test', 'Kavárna U Knihomola', 50.2096232, 15.836109);
INSERT INTO location VALUES (12, 'Budišov nad Budišovkou', 'Halaškovo náměstí', 178, '747 87', 'Test2', NULL, 49.7943254, 17.6264516);
INSERT INTO location VALUES (43, 'Brno', NULL, NULL, NULL, NULL, 'Home', NULL, NULL);


--
-- Data for Name: meeting; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
INSERT INTO meeting VALUES (2, '2016-09-17 20:30:00+02', 'Test2', '00:12:12', 42);
INSERT INTO meeting VALUES (24, '2017-01-01 00:00:00+01', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', NULL, 37);
INSERT INTO meeting VALUES (26, '2017-12-31 23:59:00+01', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '23:59:00', 37);
INSERT INTO meeting VALUES (29, '2017-12-31 23:59:00+01', 'dasdsa', NULL, 12);
INSERT INTO meeting VALUES (30, '2018-03-02 01:02:00+01', 'dadasdasdasd', NULL, 49);


--
-- Data for Name: person; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
INSERT INTO person VALUES (56, 'dasasd', 'dasdas', 'dasdas', NULL, NULL, NULL, NULL);
INSERT INTO person VALUES (57, 'sdffasd', 'dasdas', 'dasdas', NULL, NULL, NULL, NULL);
INSERT INTO person VALUES (38, 'LALALA', 'Florentino', 'Balfour', 34, '1966-03-16', 173, 'male');
INSERT INTO person VALUES (61, 'Gal', 'Jan', 'Šilhan', NULL, '1995-05-12', 188, NULL);
INSERT INTO person VALUES (63, 'Gal', 'Jancxycyx', 'Šilhancxycxy', NULL, '1995-05-12', 188, NULL);
INSERT INTO person VALUES (11, 'Alice', 'AL', 'Barrientos', 11, '1984-06-14', 180, 'female');
INSERT INTO person VALUES (69, 'dsadasdas', 'Jan', 'Šilhan', NULL, NULL, NULL, NULL);
INSERT INTO person VALUES (70, 'dsadasdass', 'Jan', 'Šilhan', NULL, NULL, NULL, NULL);
INSERT INTO person VALUES (71, 'Test3', 'Test', 'Test2', NULL, NULL, NULL, NULL);
INSERT INTO person VALUES (72, 'mofo', 'Jan', 'Šilhan', NULL, NULL, NULL, NULL);
INSERT INTO person VALUES (12, 'Julerd', 'Julissa', 'Erdmann', NULL, '1985-07-27', 173, 'female');
INSERT INTO person VALUES (10, 'Usher', 'Roderick', 'Colangelo', 27, '1981-05-13', NULL, 'male');
INSERT INTO person VALUES (67, 'asdasdasdasdasd', 'Jan', 'Šilhan', NULL, NULL, NULL, NULL);


--
-- Data for Name: person_meeting; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
INSERT INTO person_meeting VALUES (9, 26);
INSERT INTO person_meeting VALUES (56, 30);
INSERT INTO person_meeting VALUES (13, 26);
INSERT INTO person_meeting VALUES (49, 26);
INSERT INTO person_meeting VALUES (45, 26);
INSERT INTO person_meeting VALUES (47, 26);
INSERT INTO person_meeting VALUES (26, 26);
INSERT INTO person_meeting VALUES (41, 26);


--
-- Data for Name: relation; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
INSERT INTO relation VALUES (93, 6, 22, '', 4);
INSERT INTO relation VALUES (94, 6, 22, '', 3);
INSERT INTO relation VALUES (95, 6, 22, '', 6);
INSERT INTO relation VALUES (97, 38, 17, '', 5);
INSERT INTO relation VALUES (99, 61, 4, '', 6);
INSERT INTO relation VALUES (98, 38, 21, 'Testosxxsss', 1);
INSERT INTO relation VALUES (101, 5, 6, '', 5);


--
-- Data for Name: relation_type; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: xsilhan2
--

INSERT INTO users VALUES (1, 'xsilhan2', 'e628cfd64538a9ad87efd9959a02db3e70c21e7b');


--
-- Name: contact_id_person_id_contact_type_contact_key; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: contact_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: contact_type_name_key; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: contact_type_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: location_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: meeting_start_id_location_key; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: person_first_name_last_name_nickname_key; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: person_meeting_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: person_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: relation_id_person1_id_person2_id_relation_type_key; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: relation_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: relation_type_name_key; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: relation_type_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: schuzky_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: users_login; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: users_pkey; Type: CONSTRAINT; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: fki_meeting; Type: INDEX; Schema: public; Owner: xsilhan2; Tablespace: 
--
...
--
-- Name: contact_id_contact_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: contact_id_person_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: meeting_id_location_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: person_id_location_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--

ALTER TABLE ONLY person
    ADD CONSTRAINT person_id_location_fkey FOREIGN KEY (id_location) REFERENCES location(id_location) ON DELETE SET DEFAULT;


--
-- Name: person_meeting_id_meeting_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: person_meeting_id_person_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: relation_id_person1_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: relation_id_person2_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
...
--
-- Name: relation_id_relation_type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: xsilhan2
--
